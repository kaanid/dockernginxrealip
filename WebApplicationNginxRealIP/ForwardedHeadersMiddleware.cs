...
namespace WebApplicationNginxRealIP
{
    public class ForwardedHeadersMiddleware2
    {
        ...
        static ForwardedHeadersMiddleware2()
        {
        ...
        public ForwardedHeadersMiddleware2(RequestDelegate next, ILoggerFactory loggerFactory, IOptions<ForwardedHeadersOptions> options)
        {
            if (next == null)
            {
